  ...
  module Hooks
    class Journal
      ...
      def do_get_site_journal(starting_point = nil, info_type = 0)
          message = {session_handle: @client.session_handle, starting_point: starting_point, info_type: info_type }
      ...
      def do_get_site_journal_deals(starting_point = nil)
        message = {session_id: @client.session_handle, journal_start: starting_point }
